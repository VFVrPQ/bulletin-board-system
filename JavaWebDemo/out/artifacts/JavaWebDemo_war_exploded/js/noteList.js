...
function showNoteList(data){
    ...
    $(data).each(function (key,obj) {
        ...
        noteListHtml = noteListHtml + "            <span class=\"comments\"><a href=\"singleNote.jsp?noteId="+obj.noteId+"#comment_title\" title=\"Comment on "+obj.noteName+"\">"+(obj.noteNumber-1) +" 评论数</a></span>\n";
